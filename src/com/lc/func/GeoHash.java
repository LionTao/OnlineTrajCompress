...
public class GeoHash {
    ...
    public static final double MINLNG = min_lon;
    public static final double MAXLNG = max_lon;

    private static int numbits = 1 * 5; //经纬度单独编码长度
    ...
    public double[] decode(String geohash) {
        ...
        double lon = decode(lonset, MINLNG, MAXLNG);
        double lat = decode(latset, MINLAT, MAXLAT);
    ...
    public static void main(String[] args)  throws Exception{
        ...
        String s = geohash.encode(30.65295,104.04216);
        System.out.println(s);
        ArrayList<String> arounds = geohash.getArroundGeoHash(30.65785, 104.11483);
        double[] geo = geohash.decode("zzzzzz");
